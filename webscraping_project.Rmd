...
Each of these code chunks takes the data from a page on the website and splits it up into 3 columns split by the frist 3 spaces.
...
And here is a peak at all its glory.
```{r, message = FALSE, warning = FALSE}
pander(head(events))
```
